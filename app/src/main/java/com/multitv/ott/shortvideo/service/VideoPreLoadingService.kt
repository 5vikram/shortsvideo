package com.multitv.ott.shortvideo.service
...
class VideoPreLoadingService :
    ...
    override fun onHandleIntent(intent: Intent?) {
        ...
        if (intent != null) {
            ...
            videosList = extras?.getStringArrayList(PlayerConstant.VIDEO_LIST)
        ...
        if (!videoUrl.isNullOrBlank()) {
            ...
            val progressListener =
                CacheWriter.ProgressListener { requestLength, bytesCached, newBytesCached ->
                    ...
                    Log.e(TAG, "downloadPercentage $downloadPercentage videoUri: $videoUri")
                }
